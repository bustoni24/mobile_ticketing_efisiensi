...
<html>
  <head>
    ...
    <script src="<?= Constant::bowerUrl() ?>/bower_components/webcomponentsjs/webcomponents-lite.min.js"></script>

    <!-- Polymer components -->
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-progress/paper-progress.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-slider/paper-slider.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-button/paper-button.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-card/paper-card.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-dialog/paper-dialog.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-input/paper-input.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-input/paper-input-container.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-input/paper-input-error.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-input/paper-input-char-counter.html">
    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-input/paper-textarea.html">

    <link rel="import" href="<?= Constant::bowerUrl() ?>/bower_components/paper-styles/color.html">
    <link rel="stylesheet" href="<?= Constant::bowerUrl() ?>/bower_components/paper-styles/demo.css">
  ...
  <body unresolved>
    ...
    <paper-card heading="Bluetooth Printer">
      ...
      <paper-card id="logo">
        <div class="card-content">
          <div id="test">
            <div class="col-md-12">Hahahahhahaa</div>
          </div>
        </div>
      </paper-card>
    ...
    <script>
      ...
      document.addEventListener('WebComponentsReady', function() {
        ...
        context.drawHTMLText('<html><body><div><h4>HAHAHAHAHAHHAA</h4></div></body></html>');
