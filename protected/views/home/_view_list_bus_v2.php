<div class="card-booking card-book" data-route_id="<?= $data['route_id']; ?>" data-armada_ke="<?= $data['armada_ke'] ?>" data-penjadwalan_id="<?= (isset($data['penjadwalan_id']) ? $data['penjadwalan_id'] : '') ?>" data-label_trip="<?= $data['trip_label'] ?>" data-agen_id_asal="<?= $data['agen_id_asal'] ?>" data-agen_id_tujuan="<?= $data['agen_id_tujuan'] ?>">
