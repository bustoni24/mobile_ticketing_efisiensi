...
class CGridViewPlus3 extends CGridView {
    ...
    protected function addHeaderRow($row = "") {
        ...
        echo '<tr style="background-color: #49afcd;color: #fff;" role="row">
            ...
            <th colspan="3" style="text-align: center;vertical-align: middle;" rowspan="1">Diterima</th>
            <th colspan="3" style="text-align: center;vertical-align: middle;" rowspan="1">Dikeluarkan</th>
